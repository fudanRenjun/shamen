...
# 使用随机森林建模
model_rf = lgb.LGBMClassifier(boosting_type='dart', max_depth=100, n_estimators=100)
...
plt.title('LGBM Classification ROC Curves and AUC', fontsize=8)
...
plt.title('LGBM Classification PR Curves and AUC', fontsize=8)
