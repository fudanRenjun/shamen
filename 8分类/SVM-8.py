...
# 加载CSV文件
data = pd.read_csv('E:/RS/sm/ALL-Feature/SVM/SVM-16.csv')
...
# 使用SVM建模，并启用概率预测
model_rf = SVC(C=100, gamma='scale', kernel='rbf', probability=True)
...
print(f"Macro Average AUC with SVM: {rf_AUC_final}")
...
plt.title('SVM Classification ROC Curves and AUC', fontsize=8)
...
plt.title('SVM Classification PR Curves and AUC', fontsize=8)
