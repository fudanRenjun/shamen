...
# 使用随机森林建模
model_rf = AdaBoostClassifier(learning_rate=0.1,n_estimators=100,algorithm="SAMME.R")
...
plt.title('AdaBoost Classification ROC Curves and AUC', fontsize=8)
...
plt.title('AdaBoost Classification PR Curves and AUC', fontsize=8)
