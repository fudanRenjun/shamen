...
# 加载CSV文件
data = pd.read_csv('E:/RS/sm/ALL-Feature/XGBoost/final/XGBoost-16.csv')
...
# 使用随机森林建模
model_rf = xgb.XGBClassifier(colsample_bytree=0.5,learning_rate=0.2,max_depth=3,n_estimators=100)
...
import joblib
# 保存模型
joblib.dump(model_rf, 'E:/RS/sm/ALL-Feature/XGBoost/final/XGBoost-16.pkl')
print("模型已保存到本地")
